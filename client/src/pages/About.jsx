  ...
  return (
    <div className="py-20 px-4 max-w-6xl mx-auto">
      <h1 className="text-3xl font-bold mb-4 ">
        About <span className="text-primary">UK Real Estate</span>
      </h1>
      <p className="mb-4 text-slate-700">
        Lorem ipsum dolor sit amet consectetur adipisicing elit. Recusandae,
        doloremque dolorem? Vel sunt atque dolorum minima officia consequuntur
        pariatur voluptatibus ea debitis quibusdam!. Lorem ipsum, dolor sit amet
        consectetur adipisicing elit. Dolorem nihil architecto optio mollitia
        tempore excepturi autem quae delectus nobis odio eligendi, repellendus
        nam quos quasi quas minima quo modi? Iusto.
      </p>
      <p className="mb-4 ">
